...
namespace MVCForum.IOC
{
    ...
    public static partial class UnityHelper
    {
        ...
        private static IUnityContainer BuildUnityContainer(UnityContainer container)
        {
            ...
            container.BindInRequestScope<ITeamService, TeamService>();
            container.BindInRequestScope<ISeasonService, SeasonService>();
            container.BindInRequestScope<ILeagueService, LeagueService>();
            container.BindInRequestScope<IProbabilitiesService, ProbabilitiesService>();
            ...
            container.BindInRequestScope<ITeamRepository, TeamRepository>();
            container.BindInRequestScope<ISeasonRepository, SeasonRepository>();
            container.BindInRequestScope<ILeagueRepository, LeagueRepository>();
            container.BindInRequestScope<IProbabilitiesRepository, ProbabilitiesRepository>();
